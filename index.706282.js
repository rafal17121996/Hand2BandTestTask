...
module.exports = (function(e) {
	...
	function(e, t) {
		e.exports = __webpack_require__(294);
	},
	function(e, t, r) {
		e.exports = r(10)();
	},
	...
	function(e, t) {
		e.exports = __webpack_require__(935);
	},
	function(e, t, r) {
		'use strict';
		Object.defineProperty(t, '__esModule', { value: !0 });
...
/* harmony default export */ const store_StoreProvider = (StoreProvider);
// EXTERNAL MODULE: ./node_modules/content-type/index.js
var content_type = __webpack_require__(811);
;// CONCATENATED MODULE: ./node_modules/unsplash-js/dist/unsplash-js.esm.js


function unsplash_js_esm_extends() {
  unsplash_js_esm_extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
  ...
  return unsplash_js_esm_extends.apply(this, arguments);
}

function unsplash_js_esm_objectWithoutPropertiesLoose(source, excluded) {
  if (source == null) return {};
  var target = {};
  var sourceKeys = Object.keys(source);
  var key, i;
...
var compactDefined = function compactDefined(obj) {
  return Object.keys(obj).reduce(function (acc, key) {
    ...
    var value = obj[key];
    return unsplash_js_esm_extends({}, acc, isDefined(value) ? (_ref = {}, _ref[key] = value, _ref) : {});
  }, {});
};
function flow() {
...
var checkIsJsonResponse = function checkIsJsonResponse(response) {
  ...
  return isDefined(contentTypeHeader) && (0,content_type/* parse */.Q)(contentTypeHeader).type === CONTENT_TYPE_JSON;
};
/**
...
var handleFetchResponse = function handleFetchResponse(handleResponse) {
  return function (response) {
    return (response.ok ? handleResponse({
      ...
      return unsplash_js_esm_extends({
        type: 'error',
        status: response.status
...
var createRequestHandler = function createRequestHandler(fn) {
  return function (a, additionalFetchOptions) {
    ...
    var _fn = fn(a),
        headers = _fn.headers,
        query = _fn.query,
        baseReqParams = unsplash_js_esm_objectWithoutPropertiesLoose(_fn, ["headers", "query"]);

    return unsplash_js_esm_extends({}, baseReqParams, additionalFetchOptions, {
      query: query,
      headers: unsplash_js_esm_extends({}, headers, additionalFetchOptions.headers)
    });
  };
};
...
var initMakeRequest = function initMakeRequest(_ref) {
  var accessKey = _ref.accessKey,
      ...
      generalFetchOptions = unsplash_js_esm_objectWithoutPropertiesLoose(_ref, ["accessKey", "apiVersion", "apiUrl", "headers", "fetch"]);
  ...
  return function (_ref2) {
    ...
    return flow(handleRequest, function (_ref3) {
      ...
      var fetchOptions = unsplash_js_esm_extends({
        method: method,
        headers: unsplash_js_esm_extends({}, generalHeaders, endpointHeaders, {
...
var getPhotos = {
  handleRequest: /*#__PURE__*/createRequestHandler(function (_ref) {
    var collectionId = _ref.collectionId,
        ...
        paginationParams = unsplash_js_esm_objectWithoutPropertiesLoose(_ref, ["collectionId", "orientation"]);

    return {
      pathname: COLLECTIONS_PATH_PREFIX + "/" + collectionId + "/photos",
      query: compactDefined(unsplash_js_esm_extends({}, getFeedParams(paginationParams), {
...
var getRandom = {
  handleRequest: /*#__PURE__*/createRequestHandler(function (_temp) {
    var _ref3 = _temp === void 0 ? {} : _temp,
        ...
        queryParams = unsplash_js_esm_objectWithoutPropertiesLoose(_ref3, ["collectionIds"]);

    return {
      pathname: PHOTOS_PATH_PREFIX + "/random",
      query: compactDefined(unsplash_js_esm_extends({}, queryParams, getCollections(collectionIds))),
      headers: {
        /**
...
var getPhotos$1 = {
  handleRequest: /*#__PURE__*/createRequestHandler(function (_ref) {
    var query = _ref.query,
        ...
        filters = unsplash_js_esm_objectWithoutPropertiesLoose(_ref, ["query", "page", "perPage", "orderBy", "collectionIds", "lang", "contentFilter"]);

    return {
      pathname: SEARCH_PATH_PREFIX + "/photos",
      query: compactDefined(unsplash_js_esm_extends({
        query: query,
...
var getCollections$1 = {
  handleRequest: /*#__PURE__*/createRequestHandler(function (_ref2) {
    var query = _ref2.query,
        paginationParams = unsplash_js_esm_objectWithoutPropertiesLoose(_ref2, ["query"]);

    return {
      pathname: SEARCH_PATH_PREFIX + "/collections",
      query: unsplash_js_esm_extends({
        query: query
...
var getUsers = {
  handleRequest: /*#__PURE__*/createRequestHandler(function (_ref3) {
    var query = _ref3.query,
        paginationParams = unsplash_js_esm_objectWithoutPropertiesLoose(_ref3, ["query"]);
...
var getPhotos$2 = {
  handleRequest: /*#__PURE__*/createRequestHandler(function (_ref2) {
    var username = _ref2.username,
        ...
        paginationParams = unsplash_js_esm_objectWithoutPropertiesLoose(_ref2, ["username", "stats", "orientation"]);
...
var getLikes = {
  handleRequest: /*#__PURE__*/createRequestHandler(function (_ref3) {
    var username = _ref3.username,
        ...
        paginationParams = unsplash_js_esm_objectWithoutPropertiesLoose(_ref3, ["username", "orientation"]);
...
var getCollections$2 = {
  handleRequest: /*#__PURE__*/createRequestHandler(function (_ref4) {
    var username = _ref4.username,
        paginationParams = unsplash_js_esm_objectWithoutPropertiesLoose(_ref4, ["username"]);
...
var list$2 = /*#__PURE__*/createRequestGenerator({
  handleRequest: function handleRequest(_ref2) {
    ...
    return {
      ...
      query: compactDefined(unsplash_js_esm_extends({}, getFeedParams({
        page: page,
        perPage: perPage
      }), {
...
var getPhotos$3 = /*#__PURE__*/createRequestGenerator({
  handleRequest: function handleRequest(_ref4) {
    var topicIdOrSlug = _ref4.topicIdOrSlug,
        ...
        feedParams = unsplash_js_esm_objectWithoutPropertiesLoose(_ref4, ["topicIdOrSlug", "orientation"]);

    return {
      pathname: getTopicPhotosPath({
        topicIdOrSlug: topicIdOrSlug
      }),
      query: compactDefined(unsplash_js_esm_extends({}, getFeedParams(feedParams), {
        orientation: orientation
      }))
    };
  },
...
var internals = {
  __proto__: null,
  collections: unsplash_js_esm_index,
  photos: index$1,
  search: index$2,
  users: index$3,
...
var bem_css_modules = __webpack_require__(368);
// EXTERNAL MODULE: ./node_modules/react-horizontal-scrolling-menu/build/index.js
var build = __webpack_require__(426);
var build_default = /*#__PURE__*/__webpack_require__.n(build);
;// CONCATENATED MODULE: ./src/components/Result/Result.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const Result_module = ({"Card":"Card","Card__item":"Card__item","Card__title":"Card__title","Card__info":"Card__info","Card__card--image":"Card__card--image","fadein":"fadein","Card__page":"Card__page","Card__inputPage":"Card__inputPage","Card__form":"Card__form","Card__input-container":"Card__input-container","Card__input":"Card__input","Card__autocomplete":"Card__autocomplete","Card__back":"Card__back"});
;// CONCATENATED MODULE: ./src/components/Home/Home.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const Home_module = ({"Home":"Home","Home__container":"Home__container","Home__title":"Home__title","Home__description":"Home__description","Home__trends":"Home__trends","Home__trends--item":"Home__trends--item","Home__form":"Home__form","Home__input-container":"Home__input-container","Home__input":"Home__input","Home__autocomplete":"Home__autocomplete","fa-times":"fa-times"});
// EXTERNAL MODULE: ./node_modules/axios/index.js
var axios = __webpack_require__(669);
var axios_default = /*#__PURE__*/__webpack_require__.n(axios);
;// CONCATENATED MODULE: ./src/components/findItems.js
var showFindItems = (link, history) => {
  history.push({
    pathname: "/s/".concat(link)
  });
};

/* harmony default export */ const findItems = (showFindItems);
...
var Search = () => {
  ...
  var findHints = () => {
    axios_default().get("https://peaceful-dawn-37729.herokuapp.com/testAPI", {
      params: {
        key: query
      }
    }).then(result => {
  ...
  var style = history.location.pathname == "/" ? (0,bem_css_modules/* default */.Z)(Home_module) : (0,bem_css_modules/* default */.Z)(Result_module);
  var items = autocomplete.length ? autocomplete.map(item => /*#__PURE__*/react.createElement("li", {
    onClick: () => {
      findItems(item.query, history);
      setIsOpen(false);
      setQuery("");
    },
    key: item.query
  }, item.query)) : "Not Found";
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("form", {
    ...
    placeholder: isMobile ? "Search" : "Search for free high-resolution photos",
    value: query,
  ...
  }, /*#__PURE__*/react.createElement("ul", null, isOpen ? items : null)))));
};
...
var style = (0,bem_css_modules/* default */.Z)(Popup_module);
...
var Popup = (_ref) => {
  ...
  var place = formatter.format(Date.parse(pic.created_at.slice(0, 10))).charAt(0).toUpperCase() + formatter.format(Date.parse(pic.created_at.slice(0, 10))).slice(1);
  ...
  }, pic.user.name)), /*#__PURE__*/react.createElement("div", {
  ...
  }, pic.user.location || "Unknown"), /*#__PURE__*/react.createElement("span", {
    className: style("date")
  }, place || "Unknown")))), document.getElementById("portal"));
};

/* harmony default export */ const subComponent_Popup = (Popup);
;// CONCATENATED MODULE: ./src/components/Result/subComponent/CardItem.jsx





var CardItem_style = (0,bem_css_modules/* default */.Z)(Result_module);

var CardItem = props => {
  var [isOpen, setIsOpen] = (0,react.useState)(false);
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(react_lazy_load_image_component_build.LazyLoadImage, {
    onClick: () => setIsOpen(true),
    className: CardItem_style("card--image"),
    alt: props.pic.alt_description,
    src: props.pic.urls.small,
    width: "100%",
    effect: "blur"
  }), /*#__PURE__*/react.createElement(subComponent_Popup, {
    pic: props.pic,
    open: isOpen,
...
;// CONCATENATED MODULE: ./src/components/Result/Result.jsx
...
var Result_style = (0,bem_css_modules/* default */.Z)(Result_module);
...
var Result = () => {
  var history = useHistory();
  var [pics, setPics] = (0,react.useState)([]);
  var [info, setInfo] = (0,react.useState)([]);
  var [relatedSearches, setRelatedSearches] = (0,react.useState)([]);
  var [page, setPage] = (0,react.useState)(1);
  var [maxPage, setMaxPage] = (0,react.useState)();
  var {
    item
  } = useParams();
  (0,react.useEffect)(() => {
    ...
    axios_default().get("https://peaceful-dawn-37729.herokuapp.com/search", {
      params: {
        key: item
      }
  ...
  return /*#__PURE__*/react.createElement("section", null, /*#__PURE__*/react.createElement(Link, {
    className: Result_style("back"),
    to: "/"
  }, /*#__PURE__*/react.createElement("i", {
  ...
  }, item.charAt(0).toUpperCase() + item.slice(1), " ", info), /*#__PURE__*/react.createElement("div", {
    className: Result_style("")
  }, pics.map(pic => /*#__PURE__*/react.createElement(subComponent_CardItem, {
    key: pic.id,
    pic: pic
  }))), /*#__PURE__*/react.createElement("div", {
    className: Result_style("page")
  }, /*#__PURE__*/react.createElement("i", {
    onClick: () => handlePage(-1),
    className: "fas fa-arrow-left"
  }), /*#__PURE__*/react.createElement("input", {
    type: "text",
    className: Result_style("inputPage"),
    value: page,
...
/* harmony default export */ const Result_Result = (Result);
;// CONCATENATED MODULE: ./src/assets/bg.jpg
/* harmony default export */ const bg = (__webpack_require__.p + "79593695ec3f8cebd49ab5433a4ac325.jpg");
...
var trending = ["flower", "wallpapers", "backgroungs", "happy", "love"];
...
var Home = () => {
  ...
  return /*#__PURE__*/react.createElement("div", {
    style: {
      backgroundImage: " linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(".concat(bg, ")")
    },
    className: Home_style("")
  }, /*#__PURE__*/react.createElement("div", {
    className: Home_style("container")
  }, /*#__PURE__*/react.createElement("h1", {
    className: Home_style("title")
  }, "Unsplash"), /*#__PURE__*/react.createElement("span", {
    className: Home_style("description")
  }, "The internet\u2019s source of ", /*#__PURE__*/react.createElement("a", {
    href: "https://unsplash.com/license"
  }, "freely-usable images"), ".", " ", /*#__PURE__*/react.createElement("br", null), "Powered by creators everywhere."), /*#__PURE__*/react.createElement(Search_Search, null), /*#__PURE__*/react.createElement("span", {
    className: Home_style("trends")
  }, "Trending:", " ", trending.map(item => /*#__PURE__*/react.createElement("p", {
    onClick: () => {
      findItems(item, history);
    },
    key: item,
    className: Home_style("trends--item")
  }, item)))));
};
...
var App = () => {
  return /*#__PURE__*/react.createElement(HashRouter, null, /*#__PURE__*/react.createElement(store_StoreProvider, null, /*#__PURE__*/react.createElement(Switch, null, /*#__PURE__*/react.createElement(Route, {
    ...
    exact: true,
    path: "/s/:item"
  }, /*#__PURE__*/react.createElement(Result_Result, null)))));
};
...
if (rootElement) {
  react_dom.render( /*#__PURE__*/react.createElement(src_App, null), rootElement);
}
})();
